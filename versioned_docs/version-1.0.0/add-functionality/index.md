...
- [Add Navigation to an Embedded Dossier](./add-functionality/add-nav)
...
- [Add Event Handling to an Embedded Dossier](./add-functionality/add-event)
...
- [Retrieve and Apply Filters to an Embedded Dossier](./add-functionality/filters)
...
- [Deploy a Sample Application to Set Dossier Properties](./add-functionality/set-properties)
...
- [Methods and Properties for an Embedded Dossier](./add-functionality/methods-and-properties)
