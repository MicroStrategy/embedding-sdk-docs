...
date: Last Modified
permalink: /add-functionality.html
eleventyNavigation:
...
- [Add Navigation to an Embedded Dossier](./add-functionality/add-nav.html)
...
- [Add Event Handling to an Embedded Dossier](./add-functionality/add-event.html)
...
- [Retrieve and Apply Filters to an Embedded Dossier](./add-functionality/filters.html)
...
- [Deploy a Sample Application to Set Dossier Properties](./add-functionality/set-properties.html)
...
- [Methods and Properties for an Embedded Dossier](./add-functionality/methods-and-properties.html)
