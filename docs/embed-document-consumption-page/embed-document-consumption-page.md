---
title: Embed MicroStrategy document consumption page
description: The Embedding SDK allows you to quickly integrate a MicroStrategy document consumption page into a web application in a responsive manner. It also provides resources to add functionalities such as selecting components.
---

The Embedding SDK allows you to quickly integrate a MicroStrategy document consumption page into a web application in a responsive manner. It also provides resources to add functionalities such as selecting components.

There are three basic steps for embedding a MicroStrategy document consumption page.
...
- [Properties for an embedded MicroStrategy document consumption page](./embed-document-consumption-properties.md)

  Describes the properties that can be set for an embedded MicroStrategy document consumption page.
