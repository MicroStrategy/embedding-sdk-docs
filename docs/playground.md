...
| [Authentication](https://microstrategy.github.io/playground/?example=g17)             | How to implement SAML/OIDC/Guest/Standard authentication.                                                                                                                     |
...
| Bot Example                                                                             | Use Case                                             |
| :-------------------------------------------------------------------------------------- | :--------------------------------------------------- |
| [Embed Bot Page Example](https://microstrategy.github.io/playground/?example=g25)       | How to embed a MSTR chat bot.                        |
| [Embed Bot From Embedding API](https://microstrategy.github.io/playground/?example=g26) | How to embed a customized chatbot from embedding api |

| Visualization Example                                                           | Use Case                                                  |
| :------------------------------------------------------------------------------ | :-------------------------------------------------------- |
| [Embed Visualizations](https://microstrategy.github.io/playground/?example=g28) | How to embed native visualizations from a given dashboard |

| Library Example                                                                 | Use Case                  |
| :------------------------------------------------------------------------------ | :------------------------ |
| [Embed Visualizations](https://microstrategy.github.io/playground/?example=g24) | How to embed MSTR Library |
