---
title: Embed Library home page
description: The Embedding SDK allows you to quickly integrate a Library home page into a web application in a responsive manner. It also provides resources to add functionality such as toggling the navigation bar and sidebar, and getting group data for the current user.
---
...
- [Properties for an embedded Library home page](./embed-library-properties.md)
