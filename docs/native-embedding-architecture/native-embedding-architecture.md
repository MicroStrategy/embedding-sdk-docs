---
title: The navive embedding architecture
description: The navive embedding architecture
---

If you want to gain better performance when embedding multiple separate visualizations, we suggest you use the native embedding API. To know how to use it, you need to view the pages below:
...
The new set of APIs are still in a pre-release early version(alpha version), and might have significant changes in the future.
